    ...
    this.props.navigation.pop()
                ...
                <View style={{padding:20,flex:1}}>
                    ...
                    <Text style={{
                        ...
                        textAlign: 'left'
                    }}>{'Sign up to access your account'}</Text>
                <FieldComonent exterViewStyle={{marginTop:30}} value={this.state.email} title={'example@gmail.com'} onChangeText={(text) => {
                    ...
                    <FieldComonent exterViewStyle={{marginTop:30}} value={this.state.email} title={'Confirm Password'} onChangeText={(text) => {
                        this.setState({email:text})
                    }}>
                        <Image source={require('../../Images/passwordIcon.png')} resizeMode={"contain"}
                               style={{width: 20, aspectRatio: 1, height: undefined,tintColor:'#fff'}}/>
                    ...
                    <View style={{alignItems:'center',marginBottom:10}}>
                        <View style={{flexDirection:'row'}}>
                            ...
                            <TouchableOpacity onPress={()=>{
                                this.props.navigation.pop()
                            }} style={{alignItems:'center'}}><Text style={{color:'#fff',fontFamily:Constants.fontFamilyBold}}>Login</Text></TouchableOpacity>
                        </View>
                        <Button1Component extraviewstyle={{width:'90%'}}  title={'Sign Up'}/>
                    </View>
                </View>
            </SafeAreaView>
        );
